...
public class GlaciteCommissions extends Macro {
    ...
    public enum CommissionState {
        SCANNING, MINING, CLAIMING, COMPLETE
    }

    public enum CommissionType {
        GLACITE_MINING, UMBER_MINING, TUNGSTEN_MINING
    }

    public GlaciteCommissions() {
        super("Glacite Commissions", "Automated Glacite commissions");
    ...
    public void start() {
        ...
        System.out.println("[Glacite] Initialized");
    }
    ...
    private void scanCommissions() {
        if (activeCommissions.isEmpty()) {
            activeCommissions.add(new Commission(CommissionType.GLACITE_MINING, 1000, 0, 5000));
        }
